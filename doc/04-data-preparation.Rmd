...
file_tvb = os.path.join(data_path,'dati_TVBv2.txt')
...
dfpir = df_g14.groupby('sk').mean().T_pirG14
dfpir = dfpir.reset_index()
df = pd.merge(df,dfpir,on='sk')
...
# features = ['dim', 'lotto_contr', 'odp', 'n_risul', 'c_over_p',
#        'l_over_t', 'colata', 'ese', 'data_ins', 'anno', 'sk','kv_valori', 'temp_media',
#        'temp_sup', 'temp_inf', 'min_over_1050', 'min_over_1100',
#        'C', 'S', 'P','Si', 'Mn', 'Cr', 'Ni', 'Mo', 'Cu', 'Sn', 'Al', 'V', 'Co', 'Ti', 'Nb',
#        'Ca', 'N2', 'PA', 'Cr_eq', 'Ni_eq', 'Cr_eq_over_Ni_eq', 
#        'peso_rinv1', 'peso_rinv2']
       
# df = df[features]

# peso_barra = np.pi*0.047**2*4.5*7900  #stima del peso di una barra

# df['numero_barre_rinv1'] = round(df.peso_rinv1/peso_barra,0)

# df['numero_fasci_rinv2'] = round(df.peso_rinv2/df.peso_batch_rinv2)

# ordino le features

ordered_columns = ['dim', 'lotto_contr', 'odp', 'n_risul', 'c_over_p',
       'l_over_t', 'colata', 'ese', 'data_ins','anno_colaggio', 'colata_aod', 'sk',
        'rm_valori','kv_valori', 
       'temp_media','temp_sup', 'temp_inf', 'min_over_1050', 'min_over_1100', 
       'C', 'S', 'P','Si', 'Mn', 'Cr', 'Ni', 'Mo', 'Cu', 'Sn', 'Al', 'V', 
       'Co', 'Ti', 'Nb','Ca', 'N2', 
       'PA', 'Cr_eq', 'Ni_eq', 'Cr_eq_over_Ni_eq',
       'forno_rinv1', 'peso_rinv1',
       'forno_rinv2','peso_batch_rinv2','T_pirG14','dt_LAM_TT1','dt_TT1_TT2']
