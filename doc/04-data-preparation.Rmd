...
features = ['dim', 'lotto_contr', 'odp', 'n_risul', 'kv_valori', 'c_over_p',
       'l_over_t', 'colata','colata_aod', 'ese', 'data_ins', 'anno', 'sk', 
       'temp_media','temp_sup', 'temp_inf', 'min_over_1050', 'min_over_1100',
       'anno_colaggio', 'peso_batch', 'n_batch', 'C', 'S', 'P',
       'Si', 'Mn', 'Cr', 'Ni', 'Mo', 'Cu', 'Sn', 'Al', 'V', 'Co', 'Ti', 'Nb',
       'Ca', 'N2', 'PA', 'Cr_eq', 'Ni_eq', 'Cr_eq_over_Ni_eq', 'batch_rinv1',
       'forno_rinv1', 'peso_rinv1', 'batch_rinv2', 'forno_rinv2', 'peso_rinv2',
       'peso_batch_rinv2', 'n_batch_rinv2', 'rm_valori']
